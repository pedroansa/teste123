...
export function FinalizarConfiguracao() {
    const { plotSpecsData, siteData, solutionData } = useLayoutsData();
        ...
        <>
            ...
            >
                <Flex flexDirection="column" gap="12px">
                    <EnvironmentConfigs
                        ambientes={ambientesWithArchprog}
                        totalArea={totalArea}
                        hiddenButtons
                    />
                </Flex>
